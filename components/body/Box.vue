<template>
    <section class="flex flex-col lg:flex-row items-center justify-center gap-4 md:gap-6 relative p-3 overflow-hidden md:-mt-12">
        ...
        <div class="bg-yellow-500 p-4 w-11/12 lg:w-2/5 rounded-2xl flex items-center justify-between lg:justify-around mt-4 lg:mt-0">
            <button class="rounded outline-none px-4 py-2 hover:bg-white border border-black text-xs font-medium hover:border-white duration-500 ease-in-out" target="_blank">اینستاگرام</button>
            <h2 class=" font-medium text-lg hidden lg:block">ما را در شبکه مجازی دنبال کنید</h2>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
